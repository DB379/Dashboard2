...
<body>
    <div class="register-container">
        ...
        <form action="index.php?page=register" method="POST">
            ...
            <input type="text" id="username" name="username" required placeholder="4-20 characters">
            <label for="email">Email</label>
            <input type="email" id="email" name="email" required placeholder="Must use gmail, hotmail, outlook">
            <label for="password">Password</label>
            <input type="password" id="password" name="password" required placeholder="6-20 characters with no special characters">
